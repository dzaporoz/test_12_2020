            ...
            <div class="card card-primary card-tabs">
                <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="custom-tabs-one-clicks-tab" data-toggle="pill"
                               href="#custom-tabs-one-clicks" role="tab" aria-controls="custom-tabs-one-clicks"
                               aria-selected="false">Clicks</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="custom-tabs-one-bad-domains-tab" data-toggle="pill"
                               href="#custom-tabs-one-bad-domains" role="tab"
                               aria-controls="custom-tabs-one-bad-domains" aria-selected="true">Bad Domains</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        <div class="tab-pane fade active show" id="custom-tabs-one-clicks" role="tabpanel"
                             aria-labelledby="custom-tabs-one-clicks-tab">
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table style="width: 100%" id="clicks-table"
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example2">User Agent
                                                </th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example2">Bad Domain
                                                </th>
                                            </thead>
                                            <tbody>
                                            @foreach($clicks as $click)
                                                <tr role="row"
                                                    class="@if($loop->iteration % 2 == 0) even @else odd @endif">
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-bad-domains" role="tabpanel"
                             aria-labelledby="custom-tabs-one-bad-domains-tab">
                            <div class="row">
                                <div class="col-sm-6">
                                    <table style="width:100%" id="bad-domains-table"
                                           class="table table-bordered table-hover dataTable dtr-inline" role="grid"
                                           aria-describedby="example2_info">
                                        <thead>
                                        <tr role="row">
                                    ...
                                    <div class="card card-primary card-outline">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="newBadDomainName"
                                                       placeholder="Enter domain name">
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <button type="submit" id="createNewBadDomain" class="btn btn-primary">
                                                Create
                                            </button>
                                        </div>
                                        <!-- /.card -->
